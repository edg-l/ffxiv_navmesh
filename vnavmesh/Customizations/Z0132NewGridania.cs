...
internal class Z0132NewGridania : NavmeshCustomization
{
	...
	{
		LinkQuads(graph, new(45.03f, -0.13f, 83.1f), new(46.78f, -8.5f, 91.75f), Navmesh.AreaId.Shortcut);
		LinkQuads(graph, new(-65.98f, -0.5f, 3.3f), new(-75.4f, -0.5f, -3.47f), Navmesh.AreaId.Shortcut);
		LinkQuads(graph, new(-21.689f, -4.302f, 16.821f), new(33.436f, -1.582f, 61.284f), Navmesh.AreaId.Shortcut);
		LinkQuads(graph, new(53.482f, -0.772f, 71.466f), new(3.601f, -2.647f, 34.097f), Navmesh.AreaId.Shortcut);
	}
}